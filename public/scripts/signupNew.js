...
signUpInputFields.forEach(inputField => {
    var _a;
    (_a = inputField.selector) === null || _a === void 0 ? void 0 : _a.addEventListener('blur', event => {
        var _a;
        inputField.isValid = inputField.regex.test(((_a = inputField.selector) === null || _a === void 0 ? void 0 : _a.value));
...
serviceDropDownMenu === null || serviceDropDownMenu === void 0 ? void 0 : serviceDropDownMenu.addEventListener('change', (event) => {
